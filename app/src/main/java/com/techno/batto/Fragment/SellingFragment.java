...
public class SellingFragment extends Fragment {
    private View view;
    public static RecyclerView Rvarequestone;
    private String user_id;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.selling_fragment_layout, container, false);
        findId();
    ...
    private void findId() {
        Rvarequestone = view.findViewById(R.id.Rvarequestone);
    ...
    private void getChatCall(String id) {
        ...
        progressDialog.show();
        Call<ResponseBody> call = AppConfig.loadInterface().getSalingConversetion(id);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (object.getString("status").equals("1")) {
                            ...
                            Rvarequestone.setHasFixedSize(true);
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
                            Rvarequestone.setLayoutManager(layoutManager);
                            Rvarequestone.setItemAnimator(new DefaultItemAnimator());
                            ChatListAdapter adapter = new ChatListAdapter(getActivity(), requestListResponse.getResult(),"Selling",Rvarequestone);
                            Rvarequestone.setAdapter(adapter);
