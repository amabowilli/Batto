...
public class PeopleAdapter extends RecyclerView.Adapter<PeopleAdapter.ViewHolder> {
    ...
    public PeopleAdapter(Activity activity, List<PeopleResult> result) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.txt_username.setText(result.get(position).getUserName());
        holder.btn_follow.setText(result.get(position).getFollowSts());
        holder.btn_follow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String ldata = getData(activity, "ldata", null);
                if (ldata != null) {
                    followCall(result.get(position).getId(), holder.btn_follow);
                } else {
        ...
        holder.txt_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ldata != null) {
                    ...
                    i.putExtra("user_id", result.get(position).getId());
