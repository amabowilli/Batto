...
public class YouAdapter extends RecyclerView.Adapter<YouAdapter.ViewHolder> {
    ...
    public YouAdapter(Activity activity, List<FFResult> result) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.you_people_item_view, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.btn_yoyfollow.setText("Requested");
        holder.btn_yoyfollow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(activity, "clicked!!!", Toast.LENGTH_SHORT).show();
                followCall(result.get(position).getUserDetail().getId(), holder.btn_yoyfollow);
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            btn_yoyfollow = itemView.findViewById(R.id.btn_yoyfollow);
        }
