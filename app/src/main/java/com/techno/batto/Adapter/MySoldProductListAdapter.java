...
public class MySoldProductListAdapter extends RecyclerView.Adapter<MySoldProductListAdapter.ViewHolder> implements View.OnClickListener {
    private Activity activity;
    private View view;
    private List<MyProductResult> result;
    private String user_id, request_id;

    public MySoldProductListAdapter(Activity activity, List<MyProductResult> result) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        try {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_sold_product_item, parent, false);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//     .addButton("Sale", R.color.pdlg_color_white, R.color.pdlg_color_blue,
//                                new PrettyDialogCallback() {
//        @Override
//        public void onClick() {
//            pDialog.dismiss();
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (object.getString("status").equals("1")) {
                            ...
                            MySoldProductListAdapter adapter = new MySoldProductListAdapter(activity, requestListResponse.getResult());
